...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d8267156422fbac85e0ce33b175f6747f8088828b7f45c962b56b290fb5a6f72');
    ...
    {
        return $this->services['prestashop.core.api.category.repository'] = new \PrestaShopBundle\Entity\Repository\CategoryRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ps_site_echec_');
    }
    ...
    {
        return $this->services['prestashop.core.api.feature_attribute.repository'] = new \PrestaShopBundle\Entity\Repository\FeatureAttributeRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ps_site_echec_');
    }
    ...
    {
        return $this->services['prestashop.core.api.manufacturer.repository'] = new \PrestaShopBundle\Entity\Repository\ManufacturerRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ps_site_echec_');
    }
    ...
    {
        return $this->services['prestashop.core.api.stockmovement.repository'] = new \PrestaShopBundle\Entity\Repository\StockMovementRepository($this, $this->get('doctrine.dbal.default_connection'), $this->get('doctrine.orm.default_entity_manager'), $this->get('prestashop.adapter.legacy.context'), $this->get('prestashop.adapter.image_manager'), 'ps_site_echec_');
    }
    ...
    {
        return $this->services['prestashop.core.api.supplier.repository'] = new \PrestaShopBundle\Entity\Repository\SupplierRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'ps_site_echec_');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('ps_site_echec_');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('QRW5OKhmguhvxAFFDoOFrF1Yi8KqG4GFWbqX1ndaJ2EKy0JUvj1CBiTA');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a0af9b8a14e56.40746513')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => '',
            'database_prefix' => 'ps_site_echec_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'QRW5OKhmguhvxAFFDoOFrF1Yi8KqG4GFWbqX1ndaJ2EKy0JUvj1CBiTA',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-11-14',
            'locale' => 'fr-FR',
            'cookie_key' => '6RSJ6kTwEf1Ok96taD8YEs3VUg0BUD1yesRFIvTERstLc2dXP4d3JF8u',
            'cookie_iv' => 'ODxUto4f',
            'new_cookie_key' => 'def000004636f0f6049b65e586447804275fae04af60407c97a833983232e929ca36dac166c2763796f41c8b1833cb30279888a34a045cc4dda3950041c8cdff5df7bc10',
            ...
            'kernel.secret' => 'QRW5OKhmguhvxAFFDoOFrF1Yi8KqG4GFWbqX1ndaJ2EKy0JUvj1CBiTA',
