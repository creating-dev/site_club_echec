 ...
 **/
	...
	// localisable text
	$.dpText = {
		TEXT_PREV_YEAR		:	datepicker_annee_precedente,
		TEXT_PREV_MONTH		:	datepicker_mois_precedent,
		TEXT_NEXT_YEAR		:	datepicker_annee_suivante,
		TEXT_NEXT_MONTH		:	datepicker_mois_suivant,
		TEXT_CLOSE			:	datepicker_fermer,
		TEXT_CHOOSE_DATE	:	datepicker_selectionner_date
	};
	// version
